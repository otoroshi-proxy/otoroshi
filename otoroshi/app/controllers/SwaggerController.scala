...
class SwaggerController(cc: ControllerComponents, assetsBuilder: AssetsBuilder)(implicit env: Env)
  ...
  def ErrorTemplate =
    Json.obj(
      ...
      "type"        -> "object",
      "required"    -> Json
        .arr("serviceId", "template40x", "template50x", "templateBuild", "templateMaintenance", "messages"),
      "properties"  -> Json.obj(
