...
## [18.0.0-preview6] - 2026-09-08


https://github.com/MAIF/otoroshi/milestone/141?closed=1
https://github.com/MAIF/otoroshi/compare/v18.0.0-preview5...v18.0.0-preview6
https://github.com/MAIF/otoroshi/releases/tag/v18.0.0-preview6


### Added 

- Helm values with annotations for fixed IPs/IDs (#2631 fixed by )
- Let user choose the preferred root for ACME certificates (#2621 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Certificate CRD generated by Helm should have optional public domains (#2628 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Provide Redis custom CA cert (lettuce) from config. and env. variables instead of java *stores only. (#2616 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Otoroshi not compatible with opensearch. (#2630 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- migrate to play 3.0.0 (#1755 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- clustering test kit (#1292 fixed by [Zwiterrion](https://github.com/Zwiterrion))
- Removing service descriptor inputs/outputs (#2645 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- upgrade webauthn to make it work again (#1338 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Add support for custom plugins flow per apikey (#2646 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Change Api access strategy by using apikey for every plan kind (#2648 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- ACME certficate purge (#2649 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Frontend regressions after the webpack to vite migration (#2643 fixed by [Zwiterrion](https://github.com/Zwiterrion))
- Conditional wrapper for plugins (#2653 fixed by [mathieuancelin](https://github.com/mathieuancelin))       
      
### Changed 

- ensure the main executor for the gateway is still in the health path  (#2639 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Remove documentation from maven publish to avoid hitting maven central publish quotas (#2642 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Update build toolchain for documentation (#2651 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Optimizations for Json path evaluation (#2654 fixed by [mathieuancelin](https://github.com/mathieuancelin))       
      
### Fixed 

- NgPluginHttpResponse swallows response chunking (#2617 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Helm chart display wrong message about DNS binding in cluster mode (#2619 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Investigate issue with RDP over websocket (#2623 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Websocket chunk size is fixed when using netty server (#2627 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Docker entrypoint does not pass args to the java process (#2632 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Elastic data exporter reports a success even when the cluster rejects the events (#2635 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- Out of the box helm install seems to have broken otoroshi-admission-webhook-validation (#2637 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- ACME certificate duplication (#2650 fixed by [mathieuancelin](https://github.com/mathieuancelin))
- NgServiceQuotas, NgCustomQuotas and NgCustomThrottling return bad status code when reaching limits (#2655 fixed by [mathieuancelin](https://github.com/mathieuancelin))       
...
## [18.0.0-preview5] - 2026-09-01


https://github.com/MAIF/otoroshi/milestone/141?closed=1
https://github.com/MAIF/otoroshi/compare/v18.0.0-preview4...v18.0.0-preview5
https://github.com/MAIF/otoroshi/releases/tag/v18.0.0-preview5
...
## [18.0.0-preview4] - 2026-08-31


https://github.com/MAIF/otoroshi/milestone/141?closed=1
https://github.com/MAIF/otoroshi/compare/v18.0.0-preview3...v18.0.0-preview4
https://github.com/MAIF/otoroshi/releases/tag/v18.0.0-preview4
...
## [18.0.0-preview3] - 2026-08-24


https://github.com/MAIF/otoroshi/milestone/141?closed=1
https://github.com/MAIF/otoroshi/compare/v18.0.0-preview2...v18.0.0-preview3
https://github.com/MAIF/otoroshi/releases/tag/v18.0.0-preview3
...
## [18.0.0-preview2] - 2026-08-20


https://github.com/MAIF/otoroshi/milestone/141?closed=1
https://github.com/MAIF/otoroshi/compare/v18.0.0-preview1...v18.0.0-preview2
https://github.com/MAIF/otoroshi/releases/tag/v18.0.0-preview2
...
## [18.0.0-preview1] - 2026-08-20


https://github.com/MAIF/otoroshi/milestone/141?closed=1
https://github.com/MAIF/otoroshi/compare/v17.17.0...v18.0.0-preview1
https://github.com/MAIF/otoroshi/releases/tag/v18.0.0-preview1
...
https://github.com/MAIF/otoroshi/compare/v17.4.0...v17.5.0
...
- "Robot txt content" should be a textarea (#2215 fixed by )
